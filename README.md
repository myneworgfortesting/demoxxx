...
### Project contents
The microservice application has a health endpoint which is accessible at `<host>:<port>/demoxxx/health`. The context root is set in the `src/main/webapp/WEB-INF/ibm-web-ext.xml` file. The ports are set in the pom.xml file and exposed to the CLI in the cli-config.yml file.
...
* generator-java v2.5.3
* java-common v2.3.0
* generator-ibm-service-enablement v0.0.80
* generator-ibm-cloud-enablement v0.0.89
